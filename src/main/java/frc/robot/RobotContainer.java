...
public class RobotContainer {
    ...
    private final Telemetry logger = new Telemetry(DriveConstants.K_MAX_SPEED);

    private final CommandXboxController joystick = new CommandXboxController(InputConstants.K_XBOX_PORT);
