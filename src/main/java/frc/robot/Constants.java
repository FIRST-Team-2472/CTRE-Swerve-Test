...
public class Constants {
    ...
    public static class DriveConstants {
        public static final double K_MAX_SPEED = TunerConstants.kSpeedAt12Volts.in(MetersPerSecond) * 0.01; // kSpeedAt12Volts desired top speed
        public static final double K_AUTO_SPEED = K_MAX_SPEED * 0.50;
